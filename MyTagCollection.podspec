...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'MyTagCollection is a utility helper for handling and managing user`s tag in application with the ability to plug custom tag view as the user desires.'
