...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MyTagCollection.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Neil Francis Ramirez Hipona/MyTagCollection'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Neil Francis Ramirez Hipona' => 'enef.devops@protonmail.ch' }
  s.source           = { :git => 'https://github.com/Neil Francis Ramirez Hipona/MyTagCollection.git', :tag => s.version.to_s }
